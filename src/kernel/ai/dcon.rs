...
use alloc::vec;
use core::fmt;
use crate::kernel::no_std_shims::string;
    ...
    pub fn new_basic() -> Self {
        Self {
            rtl_params: RTLParameters {
                target_language: string::str_to_string("SystemVerilog"),
                optimization_level: string::str_to_string("Release"),
                synthesis_tool: string::str_to_string("yosys"),
                target_technology: string::str_to_string("generic"),
            },
            clock_domains: vec![
                ClockDomain {
                    domain_name: string::str_to_string("clk_main"),
                    frequency_mhz: 100,
            ...
            power_domains: vec![
                PowerDomain {
                    domain_name: string::str_to_string("core"),
                    voltage_min: 0.9,
                    voltage_max: 1.1,
