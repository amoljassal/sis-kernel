...
use x86_64::{VirtAddr, PhysAddr, structures::gdt::SegmentSelector};
...
pub fn test_us_viol() -> ! {
    ...
    if let Err(_) = memory::map_supervisor_page(VirtAddr::new(supervisor_addr)) {
        ...
        unsafe { crate::arch::x86_64::io::qemu_exit(0x11); }
    }
...
pub fn test_guard_under() -> ! {
    ...
    memory::map_user_rw_page(stack_paddr, VirtAddr::new(STACK_PAGE_VA)).expect("Failed to map stack page");
