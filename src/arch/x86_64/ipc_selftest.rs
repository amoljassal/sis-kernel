...
use crate::kernel::syscall::{SYS_IPC_CHAN_CREATE, SYS_IPC_RECV, SYS_IPC_SEND};
...
pub fn run_ipc_ping() -> ! {
    ...
    let create_result = unsafe { syscall_6(SYS_IPC_CHAN_CREATE as u64, 0, 8, 64, 0, 0, 0) };
