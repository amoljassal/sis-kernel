...
// Indian traffic pattern constants
...
export class PredictiveAutoScalingService extends EventEmitter {
  ...
  private getEducationalPattern(month: number): any {
    for (const [pattern, config] of Object.entries(EDUCATIONAL_PATTERNS)) {
